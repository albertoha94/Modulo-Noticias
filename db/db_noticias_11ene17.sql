...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2017 at 01:25 AM
...
SELECT `icono`, `encabezado`, `global`, `publicada`, `fecha_visible`
FROM `noticia` 
WHERE `idioma` = oLanguageId
AND ((`app_lider` = oAppId) OR (`global` = 1))
AND activo = 1
ORDER BY `fecha_visible` DESC, `encabezado`$$
...
(1, 5, 16, NULL, 'test', 'sdlaslkdaslkdhaskldhkasl', 0, 0, 1, '2017-01-27', '2017-01-09 12:44:22', NULL, NULL, '2017-01-09 12:44:22'),
(2, 5, 16, 'test.png', 'atest', 'sdlaslkdaslkdhaskldhkasl', 0, 0, 1, '2017-01-27', '2017-01-09 12:44:59', NULL, NULL, '2017-01-09 12:44:59'),
(3, 5, 17, NULL, 'test2', 'sdlaslkdaslkdhaskldhkasl', 0, 0, 1, '2017-01-27', '2017-01-09 12:45:18', NULL, NULL, '2017-01-09 12:45:18'),
(4, 5, 17, NULL, 'test2', 'sdlaslkdaslkdhaskldhkasl', 0, 0, 1, '2017-01-24', '2017-01-09 12:46:05', NULL, NULL, '2017-01-09 12:46:05'),
(5, 5, 18, NULL, 'test3', 'sdlaslkdaslkdhaskldhkasl', 0, 0, 1, '2017-01-02', '2017-01-09 12:46:05', NULL, NULL, '2017-01-09 12:46:05'),
(6, NULL, 16, 'icon.jpg', 'encabezado equis', 'ajua', 0, 0, 1, '2017-01-10', '2017-01-10 16:36:22', NULL, NULL, '2017-01-10 16:36:22');
