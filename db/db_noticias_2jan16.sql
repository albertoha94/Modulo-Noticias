...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2017 at 07:51 PM
...
INSERT INTO `apps` (`id_app`, `titulo`, `idioma_default`, `plataforma`, `icono`, `manejable`, `activo`, `fecha_creacion`, `fecha_edicion`, `fecha_baja`) VALUES
(5, 'Global', 16, 3, 'global.png', 0, 1, '2016-12-22 18:01:00', NULL, NULL);
...
INSERT INTO `idioma` (`id_idioma`, `titulo`, `abreviacion`, `manejable`, `activo`, `fecha_creacion`, `fecha_edicion`, `fecha_baja`) VALUES
(16, 'Ingles', 'EN', 0, 1, '2016-12-22 18:00:00', NULL, NULL);
...
INSERT INTO `plataformas` (`id_plataforma`, `titulo`, `icono`, `manejable`, `fecha_creacion`, `fecha_edicion`, `fecha_baja`) VALUES
(3, 'Unasingned', NULL, 0, '2017-01-02 12:50:00', NULL, NULL);
...
INSERT INTO `usuarios` (`id_usuario`, `usuario`, `password`, `nombre`, `ap_paterno`, `ap_materno`, `fecha_creacion`, `fecha_edicion`, `fecha_baja`) VALUES
(1, 'albertoha94', 'qwerty123', 'Alberto', 'Herrera', 'Alanis', '2017-01-02 12:22:00', NULL, NULL),
(2, 'oz111', 'qwerty123', 'Oscar', 'Hernandez', 'Hernandez', '2017-01-02 12:23:00', NULL, NULL),
(3, 'lanne_ein', 'qwerty123', 'Brenda', 'Ruiz', 'Acosta', '2017-01-02 12:24:00', NULL, NULL);
...
--
ALTER TABLE `apps`
  MODIFY `id_app` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `plataformas`
  MODIFY `id_plataforma` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
